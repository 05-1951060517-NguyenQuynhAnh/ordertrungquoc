        ...
        <section class="p-5">
            <div class="content">
                ...
                <div class="p-4 pb-1 d-flex justify-content-end">
                    ...
                    <div class="tab_add ms-3 ">
                        <a class="btn" href="./add.php"><i class="bi bi-plus-circle"></i> Thêm vận đơn</a>
                    </div>
                </div>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php if ($row['status'] == 0) : ?>
                                    <span class="tab_0 text-nowrap"><i class="bi bi-exclamation-circle-fill "></i> Hoàn
                                        thành</span>
                                    <?php else : ?>
                                    <span class="tab_1 text-nowrap"><i class="fas fa-check-circle"></i> Về kho VN</span>
                                    <?php endif; ?>
                                </td>
                                <td class="text-center">
                                ...
                                <td class="text-center">
                                    <a href="./process_delete.php?id=<?php echo $row['id']; ?>&tab=<?php echo $_SERVER['REQUEST_URI']?>">
