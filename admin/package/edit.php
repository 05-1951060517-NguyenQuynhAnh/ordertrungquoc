...
<?php 
    $id= $_GET['id'];
    $sql = "SELECT * FROM `tb_package` WHERE id='$id';";
...
<body id="body-pd">
    ...
    <div class="height-100 bg-light">
        <section class="p-5">
            <div class="content">
                <p class="fs-6 p-3 mb-0">Chỉnh sửa vận đơn</p>
                <hr class="m-0">
                <div class="add p-4">
                    <form action="process_edit.php?id=<?php echo $row['id']; ?>" method="post">
                        <div class="row">
                            <div class="col mt-2">
                                <label for="txtid">Mã vận đơn:</label>
                                <input type="text" class="col-md-12 ps-3 border py-2 " name="txtid"
                                    placeholder="Nhập mã vận đơn" value="<?php echo $row['id']; ?>" readonly>
                            </div>
                            <div class="col mt-2">
                                <label for="txtTrangthai">Trạng thái:</label>
                                <select id="inputState" name="txtTrangthai" required=""
                                    class="col-md-12 ps-3 border py-2">
                                    <option value="1"<?php echo $row['status'] == '1'?'selected':''?>>Về kho VN</option>
                                    <option <?php echo $row['status'] == '0'?'selected':''?> value="0">Hoàn thành</option>
                                </select>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col mt-2">
                                ...
                                <input type="text" class="col-md-12 ps-3 border py-2" name="txttotal"
                                    placeholder="Nhập tiền cước" value="<?php echo $row['total']; ?>"required>
                            </div>
                            <div class="col mt-2">
